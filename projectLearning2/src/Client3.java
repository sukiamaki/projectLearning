...
public class Client3 extends JFrame implements MouseListener  {
	...
	// コンストラクタ
	public Client3(Othello game, Player player) {
			...
			try{
				while(true) {//データを受信し続ける
					...
					if (inputLine != null){//データを受信したら
						...
						if(inputLine.subSequence(0, 1).equals("1")) { //先手後手情報の設定
	...
	public void sendMessage(String msg){	// サーバに操作情報を送信
		...
		out.flush();//送信データを送る
		System.out.println("サーバにメッセージを送信しました"); //テスト標準出力
	}
	...
	public static void main(String args[]){ 
		...
		Client3 oclient = new Client3(game, player);
